...
* We allow the user to have a free hand over the definition of the methods while 
    also making sure that the methods are defined.
...
Abstract methods must be defined in child classes for proper implementation of 
inheritance.
"""
